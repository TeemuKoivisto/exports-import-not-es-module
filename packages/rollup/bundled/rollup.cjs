...
browser.performance = perf;
browser.cryptoRandomBuffer = cryptoRandomBuffer$1;

const isNode = typeof process !== 'undefined' && process.release && /node|io\.js/.test(process.release.name);
const isoBrowser = browser;
isNode ? require$$1__default["default"].performance : isoBrowser.performance;
const nodeCrypto = isNode ? require$$2__default["default"] : null;
/**
 * @type {function(number):ArrayBuffer}
 */
 ...
 */
/* istanbul ignore next */
const uint32 = () => new Uint32Array(cryptoRandomBuffer_1(4))[0];
// @ts-ignore
const uuidv4Template = [1e7] + -1e3 + -4e3 + -8e3 + -1e11;
const uuidv4 = () => uuidv4Template.replace(/[018]/g, /** @param {number} c */ /** @param {number} c */ c => (c ^ uint32() & 15 >> c / 4).toString(16));
...
/* istanbul ignore next */
const computeLoggingArgs = isNode$1 ? computeNodeLoggingArgs : computeBrowserLoggingArgs;
/**
 * @param {Array<string|Symbol|Object|number>} args
 */
const print = (...args) => {
